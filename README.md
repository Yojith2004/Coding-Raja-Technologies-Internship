...
A command-line to-do list application that allows users to manage tasks and a console-based budget tracker that allows users to manage their expenses and income.
